const API_URL = 'https://plume-mighty-medicine.glitch.me/';
...
const initReserve = () => {
  ...
  const { fieldservice, fieldspec, fielddata, fieldday, fieldmonth, fieldtime, btn } = reserveForm;

  addDisabled([fieldspec, fielddata, fieldday, fieldmonth, fieldtime, btn]);
  ...
  reserveForm.addEventListener('submit', async (e) => {
    ...
    addDisabled([fieldservice, fieldspec, fielddata, fieldday, fieldmonth, fieldtime, btn])
